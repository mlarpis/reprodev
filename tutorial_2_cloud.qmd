...
Add the content from Tutorial 1 to the folder that you just created. If you don't have a record of it, you can use [this repository](https://github.com/gerkovink/reprodev-exercise_quarto) as the base. 
...
Now that you have contributed to the project and have made changes to the repository, you can create a pull request to the main repository. I will illustrate this proces on [my `reprodev-exercise_quarto` repository](https://github.com/gerkovink/reprodev-exercise_quarto)
