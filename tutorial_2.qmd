...
After making sure all changes to the folder are detected, create a commit message (`initial commit` is conventional) and click _Commit to main_, followed by _Publish branch_.
...
3. Commit the changes to the repository and push the changes to your fork of the repository on `GitHub` by clicking _Publish branch_.
